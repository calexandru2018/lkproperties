    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="?show=service-common"><i class="lnr lnr-menu-circle"></i> <span>Serviços Comuns</span></a></li>
                <li><a href="?show=service-unique"><i class="lnr lnr-tag"></i> <span>Serviços Unicos</span></a></li>
