...
<div class="container-fluid py-2 bg-light cookie-notice">
    <div class="row my-2">
        ...
        <div class="col-12 col-md-4 text-center text-md-left">
            <button type="button" class="btn btn-info text-uppercase font-weight-bold mt-2" id="cookieAgreement"><?php echo $lang['cookie']['cookieModalButton']; ?></button>
        </div>
    </div>
</div>
<script>
