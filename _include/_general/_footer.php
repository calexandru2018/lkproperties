    ...
    <div class="row">
        ...
        <div class="col-12 text-center mt-md-4 mb-4 mb-md-0 order-1 order-md-4">
            <div class="row">
                ...
                <div class="col-3">
                    <a href="index.php?lang=en<?php echo langSelector($_GET)?>" name="language" data-language="en" target ="_self">
                ...
                <div class="col-3">
                    <a href="index.php?lang=pt<?php echo langSelector($_GET)?>" name="language" data-language="pt" target ="_self">
...
<?php 
    function langSelector($get){
        $getArray = '';
        $counter = 0;
        foreach($get as $key => $value){
            if($counter == 0){
                $getArray = '';
            }elseif($counter == (count($get) -1)){
                $getArray = $getArray.'&'.$key.'='.$value;
            }else{
                $getArray = $getArray.'&'.$key.'='.$value.'';
            }
            $counter++;
