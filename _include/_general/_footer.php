    ...
    <div class="row">
        ...
        <div class="col-12 text-center mb-5 order-1 order-md-1">
            <div class="row">
                ...
                <div class="col-3">
                    <a href="<?php echo $GLOBALS['absPath'].'en'.langSelector($_GET); ?>" name="language" data-language="en" target ="_self">
                ...
                <div class="col-3">
                    <a href="<?php echo $GLOBALS['absPath'].'pt'.langSelector($_GET); ?>" name="language" data-language="pt" target ="_self">
