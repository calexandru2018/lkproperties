<div class="custom-container mx-sm-auto px-4 px-md-2 rounded text-muted">
    <div class="d-flex flex-column">
        <!-- <div class="px-0 py-2">
            <h1>Praia de Alvor</h1>
        </div> -->
        <div class="py-2">
            <figure class="figure">
                <img src="assets/img/mod2.jpg" class="figure-img img-fluid rounded" style="box-shadow: 0px 33px 10px -30px black" alt="A generic square placeholder image with rounded corners in a figure.">
                <figcaption class="figure-caption px-1">Praia de Alvor</figcaption>
            </figure>
            <!-- <section class="gallery-block grid-gallery py-0">
                <div class="custom-container px-0">
                    <div class="row">
                        ...
                        <div class="col-12 item mb-0">
                            <a class="lightbox" href="images/org.jpg">
                                <img class="img-fluid image scale-on-hover" src="images/org.jpg">
                            </a>
                        </div>
                    </div>
                </div>
