    ...
    <div class="row mx-0 mb-5">
        ...
        <div class="col-12 col-sm-6 col-lg-4 my-3 px-4 px-md-2">
            <div class="card w-100 mx-auto mx-0-md bg-light border-0">
                <a href="?show=for-rent-details&publicID=777">
                    <img class="card-img-top" src="assets/img/org.jpg" alt="Card image cap">
                </a>
                <div class="card-body px-0 bg-white text-justify">
                    <h4 class="card-title">Card title</h4>
                    <h5 class="display-5"><?php echo $lang['rentPriceHolder']['pre']; ?> 150€/<?php echo $lang['rentPriceHolder']['post']; ?></h5>
                ...
                <ul id="custom-ul" class="list-group list-group-flush d-flex flex-row flex-wrap bg-white">
                    ...
                    <!-- <li class="list-group-item px-0 text-center w-50 border-top border-bottom-0">Test 6</li> -->
                </ul>
            </div>
        </div>                
        <div class="col-12 col-sm-6 col-lg-4 my-3 px-4 px-md-2">
            <div class="card w-100 mx-auto mx-0-md bg-light border-0">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-0 text-justify">Cras justo odio</li>
                    <li class="list-group-item px-0 text-justify">Dapibus ac facilisis in</li>
                    <li class="list-group-item px-0 text-justify">Vestibulum at eros</li>
                </ul>
            </div>
        </div>                               
    </div>
